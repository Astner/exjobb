...
/** Concept ID range definitions and functions for identifying different types of objects/concepts. */
object ConceptIDs {
  /** Type alias for concept IDs, used to increase readability. */
  type ConceptID    = Long
  /** Type alias for cluster IDs, used to increase readability. */
  type ClusterID    = Long
  /** Type alias for context IDs, used to increase readability. */
  type ContextID    = Long
  ...
  /** Type alias for context counts, used to increase readability. */
  type ContextCount = Long
  /** Type alias for concept pair counts, used to increase readability. */
  type PairCount    = Long
  /** Type alias for edge weights, used to increase readability. */
  type Weight       = Double
  /** Type alias for class ID, used to increase readability. */
  type ClassID = Long
