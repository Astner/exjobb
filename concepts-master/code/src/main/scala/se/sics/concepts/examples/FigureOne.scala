...
/**
 * Running this program will create a json file as output under <project-root>/visualisation/html/
 * which you can visualize using D3.js. Just launch <project-root>/visualisation/html/index.html
 * and load the created file (figure1_sim_graph.json)
...
object FigureOne {
  ...
  def main (args: Array[String]) {
    ...
    similarityGraph.exportSimilarityGraphToJSON("../visualisation/html/figure1_sim_graph.json", 0.0, clusterAssignments)
